...
func buildThemeSourceForV2(t *Setting) ([]byte, error) {
	...
	buf.writeln("")
	buf.writeln("func (%s) Color(c fyne.ThemeColorName, _ fyne.ThemeVariant) color.Color {", t.themeStructName)
	...
	buf.writeln("		return %#v", t.disabledTextColor)
	...
	buf.writeln("	default:")
	buf.writeln("		return color.White")
	buf.writeln("	}")
	buf.writeln("}")
	buf.writeln("")
	...
	buf.writeln("		return %#v", t.padding)
	buf.writeln("	case theme.SizeNameInlineIcon:")
	buf.writeln("		return %#v", t.iconInlineSize)
